...
class MedStep1Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val medicamentosArray = resources.getStringArray(R.array.medicamentos).toList()
        val adapter = CustomArrayAdapter(requireContext(), android.R.layout.simple_dropdown_item_1line, medicamentosArray)
